...
},{"customevent":1,"element-dataset":2}],4:[function(require,module,exports){
'use strict';

var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /* eslint-env jquery */


var _eqcol = require('./eqcol');

var _eqcol2 = _interopRequireDefault(_eqcol);
...
$.fn.eqcol = function (opts) {
	return this.each(function (index, element) {
		...
		if (!instance) {
			$this.data('eqcolizer', instance = new _eqcol2.default(element, options));
		}
